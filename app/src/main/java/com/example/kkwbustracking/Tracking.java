    ...
    LocationCallback mLocationCallback = new LocationCallback()
    {
        ...
        public void onLocationResult(LocationResult locationResult)
        {
            ...
            if (locationList.size() > 0) {
                ...
                Toast.makeText(Tracking.this, location.getLatitude()+"   "+location.getLongitude(), Toast.LENGTH_SHORT).show();


                final DatabaseReference reference = database.getReference();      //return the path to the root

                reference.child("Atharva Kulkarni").child("Latitude").setValue(location.getLatitude()).addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    @Override
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            reference.child("Atharva Kulkarni").child("Longitude").setValue(location.getLongitude());
